      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Reset Passwords</a>
            ...
            <div class="col-lg-8">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold" style="color: #460d46">Password Reset</h6>
                </div>
                <div class="card-body">
                <form action="{{route('reset-password.reset')}}" method="POST">
                    {{csrf_field()}}
                    ...
                    <h5 id="emailHelp" class="form-text text-muted">default password is: </u>password</u></h5>
