                              ...
                              <div class="dropdown-menu">
                                @if($user->isActive == 1)
                                  <form action="{{route('admin.suspend-account')}}" method="post">
                                    ...
                                    <button type="submit" class="dropdown-item"><i class="fa fa-ban" aria-hidden="true"></i> <strong>&nbsp Suspend</strong></button>
                                  </form>
                                @else
                                  <form action="{{route('admin.restore-account')}}" method="post">
                                      {{csrf_field()}}
                                    <input type="text" value="{{$user->email}}" name="email" style="display: none;">
                                    <button type="submit" class="dropdown-item"><i class="fa fa-recycle" aria-hidden="true"></i> <strong>&nbsp Restore</strong></button>
                                  </form>
                                @endif
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#"><i class="fa fa-trash" aria-hidden="true"></i> <strong>&nbsp Remove</strong></a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#"><i class="fa fa-list" aria-hidden="true"></i> <strong>&nbsp Log</strong></a>
                              </div>
                            </div>
                          </td>
                          {{-- <td>
