                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            @elseif($request->status == 5)
                              <strong style="color: #0a0a0a;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Expired</strong>
                            @endif
                          </td>
                          <td>
                            <div class="btn-group dropright">
                              ...
                              <div class="dropdown-menu">                                  
                                <a class="dropdown-item" href="{{route('dc-request-details', ['requestno' => preg_replace('/[^a-zA-Z0-9\s]/', '', $request->requestno)])}}">
                                  <i class="fa fa-list-alt" aria-hidden="true"></i> 
                                  <strong>&nbsp Details</strong>
                                </a>                                
                                @if($request->unit == "3" && $request->status < 4)
                                  <div class="dropdown-divider"></div>
                                  <form action="{{route('dc-manager.revoke-request')}}" method="post">
                                    {{csrf_field()}}
                                    <input type="text" value="{{$request->requestno}}" name="revoke" style="display: none;">
                                    <a type="submit" class="dropdown-item" href="#"><i class="fa fa-window-close" aria-hidden="true"></i> <strong>&nbsp Revoke</strong></a>
                                  </form>
                                @else
                                  
                                @endif  
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('visit-report', ['requestno' => preg_replace('/[^a-zA-Z0-9\s]/', '', $request->requestno)])}}">
                                  <i class="fa fa-list" aria-hidden="true"></i>
                                  <strong>&nbsp Report</strong>
                                </a>                                
                              </div>
                            </div>
                          </td>
