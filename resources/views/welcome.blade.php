...
<html lang="en">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    {{ csrf_field() }}
                      <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <label for="email">Email</label>
                          ...
                          @elseif($errors->has('isActive'))
                            <span class="help-block">
                              <strong style="color: red;">Your Account has been suspended.</strong>
                            </span>
                          @endif
                      </div>
                      <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        <label for="password">Password</label>
                          ...
                          @endif
                          <input type="checkbox" style="" onclick="showHide()"><small style="">Show</small>
                          <input id="isActive" type="text" class="form-control" name="isActive" value="1" style="display: none" required>
                      </div>
                      <div class="form-group">
      ...
      <!-- Footer -->
        ...
        <script>
          // Get the input field
          var inputt = document.getElementById("password");
