      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Access Requests</a>          
          </div>
        </div>
      </li>
    </ul>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">All Confirmed Access Requests</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold" style="color: #460d46">Confirmed Access Requests</h6>
                  </div>
                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                      ...
                      @foreach($requests as $request)
                        <tr>
                          ...
                          <td>{{$request->date}}</td>
                          <td>
                            @if($request->is_approved == 0 && $request->is_confirmed == 1 && $request->is_rejected == 0)
                            ...
                            @elseif($request->is_approved == 0 && $request->is_rejected == 1)
                              <strong style="color: red;"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Rejected</strongp>
                            @endif
                          </td>
                          <td>
                            <a href="{{route('inf-request-details', ['requestno' => preg_replace('/[^a-zA-Z0-9\s]/', '', $request->requestno)])}}" class="btn btn-info btn-sm">Details</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
          ...
          <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: rgb(166, 163, 167);">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">Mention Rejection Reason</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
