            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form action="{{route('request-form-is.nextStore')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="">
                              ...
                              <input class="form-control" type="text" placeholder="" name="location" value="{{old('location')}}">
                            </div>
                            ...
                            <textarea name="impact" class="form-control" id="" cols="30" rows="4.5"
                                style="margin-top: 0px; margin-bottom: 0px; height: 79px;">{{old('impact')}}</textarea>
                          </div>
                        </div>
                    <div class="row form-group">
                        <div class="col-lg-12">
                          <label for="exampleInputEmail1"><i style="color: black;">Purpose</i></label>
                          <textarea name="purpose" class="form-control" id="" cols="30" rows="4">{{old('purpose')}}</textarea>
                        </div>
                    </div>
                    </div>
                    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                      <div class="btn-group mr-2" role="group" aria-label="First group">
                        <a type="button" href="{{route('request-form-is2', ['requestno' => preg_replace('/[^a-zA-Z0-9\s]/', '', $requestno)])}}" class="btn btn-primary">Previous</a>
                      </div>
